...
function onCyclePoint(x, y, z) {
  if (isFirstCyclePoint()) {
    ...
    var common = xy.concat(["Z" + xyzFormat.format(cycle.bottom), "R" + xyzFormat.format(cycle.retract)]);

    switch (cycleType) {
    case "drilling":
      writeBlock(
        gPlaneModal.format(17), gRetractModal.format(98), gAbsIncModal.format(90), gCycleModal.format(81), common,
        feedOutput.format(F)
      );
      break;
    case "counter-boring":
      if (P > 0) {
        writeBlock(
          gPlaneModal.format(17), gRetractModal.format(98), gAbsIncModal.format(90), gCycleModal.format(82), common,
    ...
    case "chip-breaking":
      ...
      writeBlock(
        gPlaneModal.format(17), gRetractModal.format(98), gAbsIncModal.format(90), gCycleModal.format(73), common,
    ...
    case "deep-drilling":
      writeBlock(
        gPlaneModal.format(17), gRetractModal.format(98), gAbsIncModal.format(90), gCycleModal.format(83), common,
        "Q" + xyzFormat.format(cycle.incrementalDepth),
    ...
    case "tapping":
      ...
      writeBlock(
        gPlaneModal.format(17), gRetractModal.format(98), gAbsIncModal.format(90), gCycleModal.format((tool.type == TOOL_TAP_LEFT_HAND) ? 74 : 84), common,
    ...
    case "left-tapping":
      ...
      writeBlock(gFeedModeModal.format(93));
      writeBlock(
        gPlaneModal.format(17), gRetractModal.format(98), gAbsIncModal.format(90), gCycleModal.format(74), common,
        "F" + pitchFormat.format(tool.threadPitch),
        sOutput.format(tool.spindleRPM),
        feedOutput.format(F)
      );
    ...
    case "right-tapping":
      ...
      writeBlock(gFeedModeModal.format(93));
      writeBlock(
        gPlaneModal.format(17), gRetractModal.format(98), gAbsIncModal.format(90), gCycleModal.format(84), common,
        "F" + pitchFormat.format(tool.threadPitch),
        sOutput.format(tool.spindleRPM)
      );
      writeBlock(gFeedModeModal.format(94));
    ...
    case "fine-boring":
      ...
      writeBlock(
        gPlaneModal.format(17), gRetractModal.format(98), gAbsIncModal.format(90), gCycleModal.format(76), common,
        "P" + milliFormat.format(P), // not optional
    ...
    case "back-boring":
      ...
      if (P > 0) {
        ...
        writeBlock(
          gPlaneModal.format(17), gRetractModal.format(98), gAbsIncModal.format(90), gCycleModal.format(77), xy,
          "Z" + xyzFormat.format(cycle.bottom - cycle.backBoreDistance),
          "R" + xyzFormat.format(cycle.bottom),
          "Q" + xyzFormat.format(cycle.shift),
          feedOutput.format(F)
        );
      }
    ...
    case "reaming":
      if (P > 0) {
        writeBlock(
          gPlaneModal.format(17), gRetractModal.format(98), gAbsIncModal.format(90), gCycleModal.format(89), common,
          "P" + milliFormat.format(P), // not optional
          feedOutput.format(F),
        ...
        writeBlock(
          gPlaneModal.format(17), gRetractModal.format(98), gAbsIncModal.format(90), gCycleModal.format(85), common,
          feedOutput.format(F),
          "E" + feedFormat.format(cycle.retractFeedrate)
        );
      }
    ...
    case "stop-boring":
      if (P > 0) {
        ...
        writeBlock(
          gPlaneModal.format(17), gRetractModal.format(98), gAbsIncModal.format(90), gCycleModal.format(86), common,
          feedOutput.format(F)
        );
      }
      break;
    case "manual-boring":
      if (P > 0) {
        writeBlock(
          gPlaneModal.format(17), gRetractModal.format(98), gAbsIncModal.format(90), gCycleModal.format(88), common,
          "P" + milliFormat.format(P), // not optional
          feedOutput.format(F)
        );
      } else {
        writeBlock(
          gPlaneModal.format(17), gRetractModal.format(98), gAbsIncModal.format(90), gCycleModal.format(87), common,
          feedOutput.format(F)
        );
      }
      break;
