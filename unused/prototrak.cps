/**
  Copyright (C) 2008-2011 by HSMWorks ApS
  All rights reserved.
...
legal = "Copyright (C) 2008-2011 HSMWorks ApS";
...
var nFormat = createFormat({preifx:"N", width:4, zeropad:true, decimals:0});
...
function writeBlock() {
  if (properties.showSequenceNumbers) {
    writeWords2("N" + nFormat.format(sequenceNumber % 10000), arguments);
